...
class TestQuestions(unittest.TestCase):
    ...
    def test_question_with_empty_fields(self):
        ...
        #self.assertEqual(q_resp["error"],"These fields are required(topic,body)")
    ...
    def test_upvote_question_success(self):
        ...
        #q_resp = json.loads(response.data.decode('utf-8',KEY))
    ...
    def test_upvote_question_fail(self):
        response = self.client.patch(
            '/api/v1/qSuestions/100/upvote')
        #q_resp = json.loads(response.data.decode('utf-8',KEY))
        self.assertEqual(response.status_code, 404)
        #self.assertEqual(q_resp["error"], "Your question was not found")
